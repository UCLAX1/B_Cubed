...
diymall_70kg = Servo(13, initial_value=None)  # Continuous (Physical Pin 32)
annimos_150kg = Servo(12, initial_value=None)  # Standard (Physical Pin 33)
...
try:
    ...
    annimos_150kg.value = 0.1 # Move to center position
    sleep(2)
    annimos_150kg.value = 0
